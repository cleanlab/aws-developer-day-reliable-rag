...
CUSTOM_EVALS: list[TrustworthyRAGEval] = [
    ...
    # Instruction adherence: mentions "context"?
    TrustworthyRAGEval(
        name="mentions_context",
        criteria="Evaluate if the Response mentions the word \"context\" in any way, as a reference to external"
